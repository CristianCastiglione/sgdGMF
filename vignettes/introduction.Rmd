...
plt.res.fit.glm = plot(gmf, type = "res-v-fit", partial = TRUE)
plt.res.hist.glm = plot(gmf, type = "res-hist", partial = TRUE)
plt.res.fit.gmf = plot(gmf, type = "res-v-fit", partial = FALSE)
plt.res.hist.gmf = plot(gmf, type = "res-hist", partial = FALSE)
...
plt.ant = heatmap.sgdgmf(gmf, limits = range(c(Y)), type = "data")
plt.fit = heatmap.sgdgmf(gmf, limits = range(c(Y)), type = "response")
...
plt = biplot(gmf, palette = c("viridis", "inferno"))
ggpubr::ggarrange(
