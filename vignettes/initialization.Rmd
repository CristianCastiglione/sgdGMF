...
#   try(install.packages("mvabund", repos = "https://cloud.r-project.org"), silent = TRUE) 
# }
```
...
```{r data}
# tryCatch(
#   expr = {data(antTraits, package = "mvabund")},
#   finally = {load(url("https://raw.githubusercontent.com/cran/mvabund/master/data/antTraits.RData"))}
# )
