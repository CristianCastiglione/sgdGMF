...
init_pois = init.gmf.param(Y_pois, ncomp = 3, family = poisson(), method = "ols")
init_bin = init.gmf.param(Y_bin, ncomp = 3, family = binomial(), method = "ols")
init_gam = init.gmf.param(Y_gam, ncomp = 3, family = Gamma(link = "log"), method = "ols")
